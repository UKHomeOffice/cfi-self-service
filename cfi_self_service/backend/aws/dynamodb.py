...
class DynamoDB:
    ...
    def __init__(self, region_name, table_name):
        ...
        """
        Initializes the DynamoDB class.
    ...
    def create_item(self, item):
        ...
        try:
            ...
            raise ValueError(f'Failed to create item: {e}') from e
    ...
    def get_item(self, key):
        ...
        try:
            ...
            raise ValueError(f'Failed to get item: {e}') from e
    ...
    def update_item(self, key, update_expression, expression_attribute_names, expression_attribute_values):
        ...
        try:
            ...
            raise ValueError(f'Failed to update item: {e}') from e
    ...
    def delete_item(self, key):
        ...
        try:
            ...
            raise ValueError(f'Failed to delete item: {e}') from e
    ...
    def scan_access_requests_table(self, selected_status=None, selected_environment=None):
        ...
        Raises:
            ValueError: If an error occurs during the scanning process.
                The error message will provide details about the failure.
        Note:
        ...
        try:
            ...
            raise ValueError(f'Failed to scan table: {e}') from e
    ...
    def scan_for_approved_environments(self, status=None, user=None):
        ...
        Raises:
            ValueError: If the scan operation fails.
        Example:
            This method is typically used to retrieve approved environments for a specific user.
            For example, it can be used to fetch all environments approved for a particular user
            so that they can view their approved access.
        Note:
            - The method expects the 'status' and 'user' parameters to be provided to filter the results.
            - It uses the 'DynamoDB' instance to interact with the DynamoDB table.
        ...
        try:
            ...
            # Raise a ValueError if the scan operation fails:
            raise ValueError(f'Failed to scan table: {e}') from e
