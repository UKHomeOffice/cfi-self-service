...
def csv_data_export(sorted_items):
    ...
    This function takes a list of dictionaries representing rows of data and converts
    it into a CSV-formatted string. Each dictionary in the list represents a row,
    with keys as column headers and values as corresponding values.
    ...
    Example:
        This function is typically used to export data in CSV format, such as access request details.
    Note:
